...
:loop
echo Enter command (/accept [username] or /deny [username] [reason]):
set /p command=

:: Check if the command starts with /accept or /deny
if /i "!command:~0,7!"=="/accept" (
    set username=!command:~8!
    echo Sending approval request for username: !username!
    ...
    echo Sending denial request for username: !username! with reason: "!reason!"
...
## Batch file script for handling commands ## 
